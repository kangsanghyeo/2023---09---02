...
if __name__ == "__main__":
    ...
    while run:
        ...
        if game_state == GAME_INIT:
            ...
            text = sf.render("{0} ˚, {1} m/s".format(direction, int(power)), True, (0, 0, 0))
            screen.blit(text, pos2)

            sf = pygame.font.SysFont("Monospace", 20)
            text = sf.render('Stones : {0}   Score : {1}'.format(stone_count, score), True, (0, 0, 255))
